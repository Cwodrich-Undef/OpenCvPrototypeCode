...
class TheIranIraqWar extends OpenCvPipeline {
     ...
     */
    double PERCENT_COLOR_THRESHOLD = 0;
    ...
    public Mat processFrame(Mat input) {
         ...
         */
        if((coneLeft && coneRight && coneMiddle) || (coneLeft && coneRight) || (coneLeft && coneMiddle) || (coneRight && coneMiddle)) {
            location = Location.CRING;
            telemetry.addData("Cone Location:", "Not Found, you are a bozo");
            //bad, no cringe
        }else if(coneLeft){
