...
class Color3 extends OpenCvPipeline {
    Telemetry telemetry;
    Mat mat = new Mat();
    /**
    ...
    Color3(Telemetry t){telemetry = t;}
    ...
    public Mat processFrame(Mat input) {
         ...
         */
        Scalar lowHSV = new Scalar(15, 40, 38);
        Scalar highHSV = new Scalar(20, 52, 50);
        ...
        if(coneRight && coneLeft) {
            ...
            telemetry.addData("Color3:", "Not Found, you are a bozo");
            //bad, no cringe
        }else if(coneLeft){
            location = Location.LEFT;
            telemetry.addData("Color3:", "FOUND");
            //cone left
