...
class Color2 extends OpenCvPipeline {
    Telemetry telemetry;
    Mat mat = new Mat();
    /**
    ...
    Color2(Telemetry t){telemetry = t;}
    ...
    public Mat processFrame(Mat input) {
         ...
         */
        Scalar lowHSV = new Scalar(35, 18, 18);
        Scalar highHSV = new Scalar(50, 24, 28);
        ...
        if(coneRight && coneLeft) {
            ...
            telemetry.addData("Color2:", "Not Found, moving to color3");
            //bad, no cringe
        }else if(coneLeft){
            location = Location.LEFT;
            telemetry.addData("Color2:", "FOUND");
            //cone left
